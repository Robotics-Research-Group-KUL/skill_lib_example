...
def main(args=None):
    ...
    load_task_list("$[etasl_ros2_application_template]/skill_specifications/libraries/skill_lib_example/tasks/rosbag_record_fsm.json",blackboard)

    rosbag_rec = RosbagRecorder()
    
    # sm = MyStateMachine()
    sm  = Sequence("CalibrationRoutine", children=[
                                                StartRecording(rosbag_recorder=rosbag_rec,topics=["/joint_states", "/tf"], output_file_name="test_recording_1"),
                                                ...
                                                StartRecording(rosbag_recorder=rosbag_rec,topics=["/joint_states", "/tf"], output_file_name="test_recording_2"),
